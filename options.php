<div class="wrap">
	...
	<style type="text/css">
		.wp_upload_rename_option {
			padding-left: 30px;
		}

		.wp_upload_rename_option b {
	...
	<div id="wp_upload_rename_options" class="inside">
		...
		<div class="wp_upload_rename_option">
			If you have any <b>Questions</b> or good <b>Ideas</b>. Please <a href="mailto:zhounan0120@gmail.com">Mail to
				me</a>,<br/>
			...
			If you like it, <a href="http://wordpress.org/plugins/wp-upload-rename/" target="_blank">Rate It Here</a>,
			and I won't mind if you want to buy me a cup of coffee. :)
			<form id="donate" name="_xclick" action="https://www.paypal.com/us/cgi-bin/webscr" method="post"
				  target="_blank">
